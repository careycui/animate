    ...
    var CKobject = {
		...
		embedSWF: function(C, D, N, W, H, V, P) {
			var getFlashLink = window.getFlashLink = function(obj){
				if("PCJS" in window){
					//萤石工作室打开下载flash地址
					PCJS.openMoreWeb('http://aihdownload.adobe.com/bin/live/install_flashplayer16x32_mssa_aaa_aih.exe');
					return false;
				}else{
					//浏览器打开下载flash地址
            ...
            t = !("PCJS" in window)  ?  '<a href="javascript:;" style="color:rgb(0, 102, 204)" target="_blank" onclick="getFlashLink()">请点击此处下载安装最新的flash插件</a><span>，安装完成后请重启客户端</span>':'<a href="javascript:;" style="color:rgb(0, 102, 204)" target="_blank" onclick="getFlashLink()">请点击此处下载安装最新的flash插件</a><span>，安装完成后请刷新页面</span>' ,
            error = {
